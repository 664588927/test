...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        mHeaderView.setmParentView(this);
        ...
        mFooterView.setmParentView(this);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mEnablePullLoad) {
                    if (mFooterView.getHeight() > 0 && mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA) {
                        startLoadMore();
                        resetFooterHeight();
    ...
    private void updateFooterHeight(float delta) {
        ...
        //   update by shijiwei on 10.31
        //if (height >= PULL_LOAD_MORE_DELTA + 10)
