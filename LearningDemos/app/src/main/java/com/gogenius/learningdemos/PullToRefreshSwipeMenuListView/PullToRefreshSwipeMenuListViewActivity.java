package com.gogenius.learningdemos.PullToRefreshSwipeMenuListView;
...
/**
 * Created by shijiwei on 2016/10/31.
 */
public class PullToRefreshSwipeMenuListViewActivity extends Activity implements IXListViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prefreshswipemenulistview);
    ...
    private void open(ApplicationInfo item) {
        // open app
        Intent resolveIntent = new Intent(Intent.ACTION_MAIN, Uri.parse("https://www.baidu.com/"));
