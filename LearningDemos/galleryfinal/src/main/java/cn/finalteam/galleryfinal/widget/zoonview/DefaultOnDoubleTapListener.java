...
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    private cn.finalteam.galleryfinal.widget.zoonview.PhotoViewAttacher photoViewAttacher;
     ...
     */
    public DefaultOnDoubleTapListener(cn.finalteam.galleryfinal.widget.zoonview.PhotoViewAttacher photoViewAttacher) {
     ...
     */
    public void setPhotoViewAttacher(cn.finalteam.galleryfinal.widget.zoonview.PhotoViewAttacher newPhotoViewAttacher) {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        //update by shijiwei 2016.10.8 start
        float scale = photoViewAttacher.getScale();

        if (scale == photoViewAttacher.getMinimumScale())
            if (photoViewAttacher.mOnSingleTapConfiredListener != null)
                photoViewAttacher.mOnSingleTapConfiredListener.onSingleTap();

        //update by shijiwei 2016.10.8 end
